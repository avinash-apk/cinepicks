      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">{
            ...
            <h1 className="text-5xl font-bold text-white hover:text-cinema-red tracking-tighter cursor-pointer">CINEPICKS
            </h1>
            </a>
          }
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#trending" className="text-gray-300 hover:text-cinema-red transition-colors px-3 py-2 rounded-md font-medium">Trending</a>
            </div>
          </div>
